...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Dustin Kelley
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>I am a front end focused web developer who is passionate about bringing project ideas to life.</p>
